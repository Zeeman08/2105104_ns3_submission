...
Usage:
    python3 plot_simple.py --results-dir cerl-results --velocity 5
"""
import argparse, os
import pandas as pd
...
def main():
    ...
    parser.add_argument("--velocity", default="5", type=float)
    ...
    ax_tput.set_title(
        f"NewReno vs CERL vs A-CERL vs M-CERL — Velocity: {velocity:.1f} m/s",
    ...
    out = os.path.join(args.results_dir, f"comparison_{int(velocity)}ms.png")
